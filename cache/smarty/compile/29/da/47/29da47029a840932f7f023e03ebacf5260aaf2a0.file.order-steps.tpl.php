<?php /* Smarty version Smarty-3.1.19, created on 2017-01-24 08:04:18
         compiled from "C:\wamp64\www\mshop\themes\default-bootstrap\order-steps.tpl" */ ?>
<?php /*%%SmartyHeaderCode:232745886fc72d2d520-88525544%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '29da47029a840932f7f023e03ebacf5260aaf2a0' => 
    array (
      0 => 'C:\\wamp64\\www\\mshop\\themes\\default-bootstrap\\order-steps.tpl',
      1 => 1484224180,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '232745886fc72d2d520-88525544',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5886fc73388998_77998594',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5886fc73388998_77998594')) {function content_5886fc73388998_77998594($_smarty_tpl) {?>
...
">
	...
	<li class="<?php if ($_smarty_tpl->tpl_vars['current_step']->value=='shipping') {?>step_current<?php } else { ?><?php if ($_smarty_tpl->tpl_vars['current_step']->value=='payment') {?>step_done step_done_last<?php } else { ?>step_todo<?php }?><?php }?> four">
		...
		<a href="<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['multi_shipping']->value) {?><?php echo "&multi-shipping=";?><?php echo (string)$_smarty_tpl->tpl_vars['multi_shipping']->value;?><?php }?><?php $_tmp11=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,((string)Smarty::$_smarty_vars['capture']['url_back'])."&step=2".$_tmp11), ENT_QUOTES, 'UTF-8', true);?>
">
